        ...
        {days.map((day, idx) => {
          ...
          return (
            <button
              ...
              className={`relative p-2 md:p-4 rounded-xl border flex flex-col items-center md:items-start justify-center md:justify-between transition-all aspect-square md:aspect-auto ${
                isSelected 
            ...
            >
              ...
              {count > 0 && (
                <div className="flex items-center space-x-1 mt-1 md:mt-2">
                   ...
                   <span className="hidden md:inline text-xs opacity-80">{count} Tareas</span>
                </div>
              )}
            </button>
          );
